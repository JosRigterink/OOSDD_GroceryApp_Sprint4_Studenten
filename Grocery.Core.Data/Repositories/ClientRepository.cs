// Bestand: Grocery.Core.Data.Repositories/ClientRepository.cs
using Grocery.Core.Interfaces.Repositories;
using Grocery.Core.Models;
using Grocery.Core; // Zorg ervoor dat de namespace voor Role is geïmporteerd
    ...
    public class ClientRepository : IClientRepository
    {
        ...
        public ClientRepository()
        {
            clientList = [
                ...
                // User 3 krijgt nu de Role.Admin toegewezen
